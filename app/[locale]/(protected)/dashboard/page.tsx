        ...
        <div className="2xl:col-span-3 lg:col-span-4 col-span-12">
          <WelcomeBlock>
            <div className="max-w-[180px] relative z-10">
              <div className="text-xl font-medium text-primary-foreground dark:text-default-900 mb-2">
                {/* {t("widget_title")} */}
                SAMS Airline Maintenance
              </div>
              <p className="text-sm text-primary-foreground dark:text-default-900">
                {/* {t("widget_desc")} */}
                Analytical Flight Plan
              </p>
            </div>
            <Image

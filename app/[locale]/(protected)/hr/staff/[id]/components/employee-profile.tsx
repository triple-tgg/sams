...
import { STAFF_INFO, RATINGS, EMPLOYMENT, MATRIX, CATEGORIES, TRAINING_HIGHLIGHTS, FLOW_STEPS, SIGN_OFF, TABS } from './data';
...
export default function EmployeeProfile() {
  ...
  return (
    <div style={{ flex: 1, overflowY: 'auto', padding: '24px 28px', fontFamily: "'Inter', system-ui, -apple-system, sans-serif" }}>
      ...
      {tab === 'Flowchart' && (
        <FlowchartTab steps={FLOW_STEPS} />
      )}

      {/* ── Sign-off ── */}
      <SignOff name={SIGN_OFF.name} title={SIGN_OFF.title} date={SIGN_OFF.date} />
    </div>
  );
}

...
import { Users, CheckCircle2, BookOpen, AlertOctagon, Timer, CalendarDays, Award } from 'lucide-react';
...
export const QUICK_STATS: QuickStatItem[] = [
    { label: 'Courses Completed This Month', val: '47', icon: <CheckCircle2 className="h-6 w-6" />, color: C.green, bg: C.greenL, border: '#86efac' },
    { label: 'Avg. Days to Renew', val: '8.4', icon: <Timer className="h-6 w-6" />, color: C.primary, bg: C.primary5, border: C.primary4 },
    { label: 'Upcoming Expirations (30d)', val: '21', icon: <CalendarDays className="h-6 w-6" />, color: C.orange, bg: C.orangeL, border: '#fcd34d' },
    { label: 'Certifying Staff Compliant', val: '93%', icon: <Award className="h-6 w-6" />, color: C.primary, bg: C.primary5, border: C.primary4 },
];

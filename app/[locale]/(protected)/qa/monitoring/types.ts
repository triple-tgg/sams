...
export function getStatus(dueStr: string): string {
...
export const STATUS_META: Record<string, { bg: string; dot: string; text: string; label: string }> = {
...
export const STATUS_CLASSES: Record<string, { bg: string; dot: string; text: string }> = {

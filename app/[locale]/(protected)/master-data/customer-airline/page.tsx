...
const CustomerAirlinePage = () => {
    ...
    const [filterEmailTo, setFilterEmailTo] = useState("");
    const [filterEmailCc, setFilterEmailCc] = useState("");
    ...
    const { data, isLoading, error, refetch, isFetching } = useAirlinesList(
        {
            ...
            ...(appliedFilters.emailTo && { emailTo: appliedFilters.emailTo }),
            ...(appliedFilters.emailCc && { emailCc: appliedFilters.emailCc }),
        },
        true
    );
    ...
    const handleSearch = useCallback(() => {
        ...
        setAppliedFilters({
            ...
            emailTo: filterEmailTo.trim() || undefined,
            emailCc: filterEmailCc.trim() || undefined,
        });
    }, [filterCode, filterName, filterEmailTo, filterEmailCc]);
    ...
    const hasActiveFilters = !!(appliedFilters.code || appliedFilters.name || appliedFilters.emailTo || appliedFilters.emailCc);
                        ...
                        <>
                            ...
                            <div className="flex flex-wrap items-end gap-3 mb-4">
                                ...
                                <div className="flex-1 min-w-[140px] max-w-[220px]">
                                    <label className="text-xs font-medium text-muted-foreground mb-1 block">Email To</label>
                                    <Input
                                        placeholder="Search email to..."
                                        value={filterEmailTo}
                                        onChange={(e) => setFilterEmailTo(e.target.value)}
                                        onKeyDown={handleFilterKeyDown}
                                        className="h-9"
                                    />
                                </div>
                                <div className="flex-1 min-w-[140px] max-w-[220px]">
                                    <label className="text-xs font-medium text-muted-foreground mb-1 block">Email CC</label>
                                    <Input
                                        placeholder="Search email cc..."
                                        value={filterEmailCc}
                                        onChange={(e) => setFilterEmailCc(e.target.value)}
                                        onKeyDown={handleFilterKeyDown}
                                        className="h-9"
                                    />
                                </div>

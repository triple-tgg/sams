      ...
      <div className="bg-gradient-to-r from-slate-50 to-gray-50 rounded-lg p-4 border border-slate-200">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2 pr-10">
            ...
            <Switch
              checked={isPartsTools}
              onCheckedChange={(checked) => {
                if (!checked) {
                  form.setValue('partsTools', [])
                }
                if (checked) {
                  handleAddItem()
                }
                setIsPartsTools(checked)
              }}
            />
            {/* </div> */}
          </div>
              ...
              <div className="mb-6">
                <div className="bg-slate-50 rounded-lg p-4 mb-6 border border-slate-200">
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    ...
                    {form.watch(`partsTools.${index}.isLoan`) && (
                      <div className="col-span-2">
                        <FormField
                          control={form.control}
                          name={`partsTools.${index}.loanRemark`}
                          render={({ field }) => (
                            <FormItem>
                              <FormLabel> Loan Remark</FormLabel>
                              <FormControl>
                                <Textarea
